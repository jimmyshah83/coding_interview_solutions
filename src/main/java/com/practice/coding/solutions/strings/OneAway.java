...
public class OneAway {
    ...
    /**
     * We know that if there is a insert or delete, one String is 1 element greater
     * or smaller than other Also, we add elements of 1 string to set and let then
     * using the above assumption, compare other string characters with the ones in
     * set to see if the difference is 0 OR 1
     * 
